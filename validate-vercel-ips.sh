#!/bin/bash
# Validation script for testing Vercel IP ranges accessibility
# Linux/macOS version for comparison testing from VPS or other networks

echo "========================================"
echo "Vercel IP Range Validation Script (Unix)"
echo "Testing accessibility from your network"
echo "========================================"
echo ""

# Test main Vercel ranges
...
echo "Tracing route to vercel.com (limited to 10 hops):"
traceroute -m 10 vercel.com
echo ""
...
echo ""
echo "For comparison, run this script from different networks"
echo ""